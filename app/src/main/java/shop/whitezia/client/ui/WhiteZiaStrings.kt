...
interface WhiteZiaStrings {
    ...
    val whiteZiaResolversLabel: String
    val whiteZiaConfigsLabel: String
    val whiteZiaConfigsDescription: String
    val whiteZiaAggressiveConfigsLabel: String
    val whiteZiaAggressiveConfigsDescription: String
    val whiteZiaLogsLabel: String
    val whiteZiaDiagnosticsLabel: String
...
object EnglishStrings : WhiteZiaStrings {
    ...
    override val bannerBatteryBody = "Allow WhiteZia to ignore battery optimization so the VPN keeps running after you leave the app."
    ...
    override val settingGuideIntro = "Setting profiles change how the MasterDNS/StormDNS client behaves after you choose a connection and resolver list. Most values are MasterDNS/StormDNS client_config.toml runtime knobs; Android-only helpers are marked by WhiteZia behavior."
    override val settingGuideSource = "Based on MasterDNS/StormDNS client_config.toml and WhiteZia runtime behavior."
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                SettingsGuideEntry(
                    ...
                    effect = "More workers can help heavy traffic on fast phones. Too many workers waste battery and CPU; WhiteZia keeps process workers at least as high as RX/TX workers.",
                ),
                SettingsGuideEntry(
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                ...
                SettingsGuideEntry(
                    ...
                    body = "WhiteZia can expose an HTTP proxy bridge next to the SOCKS5 listener for apps that do not support SOCKS5.",
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                ...
                SettingsGuideEntry(
                    ...
                    body = "WhiteZia can send small test requests after connect and then keep sending occasional probes.",
    ...
    override val supportTitle = "SUPPORT WHITEZIA"
    override val supportBody = "WhiteZia is free and open source. If you find it useful, consider supporting development."
    ...
    override val bannerNotificationBlockedBody = "WhiteZia needs permission to show notifications so the VPN stays running. Tap below to grant permission."
    override val bannerFullVpnWarningTitle = "FULL VPN PERFORMANCE WARNING"
    override val bannerFullVpnWarningBody = "Full VPN mode routes all device traffic through WhiteZia. This may increase latency and battery usage compared to Proxy mode."
    ...
    override val shareSubjectProfile = "WhiteZia profile"
    override val shareChooserProfile = "Export WhiteZia profile"
    ...
    override val footerPoweredBy = "Powered by WhiteZia"
    ...
    override val whiteZiaResolversLabel = "WhiteZia resolvers"
    override val whiteZiaConfigsLabel = "WhiteZia configs"
    override val whiteZiaConfigsDescription = "Conservative: lower data usage, recommended for most users"
    override val whiteZiaAggressiveConfigsLabel = "High usage configs"
    override val whiteZiaAggressiveConfigsDescription = "High usage: use when internet usage is not a concern"
    override val whiteZiaLogsLabel = "WhiteZia logs"
    override val whiteZiaDiagnosticsLabel = "WhiteZia diagnostics"
    ...
    override val brandWhiteZia = "WhiteZia"
    ...
    override val qrScanNoCode = "No WhiteZia QR profile found"
    override val qrScanCancelled = "QR scan cancelled"

}

object PersianStrings : WhiteZiaStrings {
    ...
    override val bannerBatteryBody = "به WhiteZia اجازه دهید بهینه‌سازی باتری را نادیده بگیرد تا VPN بعد از خروج از برنامه فعال بماند."
    ...
    override val settingGuideIntro = "پروفایل تنظیمات مشخص می‌کند کلاینت MasterDNS/StormDNS بعد از انتخاب اتصال و لیست ریزالورها چطور کار کند. بیشتر گزینه‌ها همان تنظیمات runtime در client_config.toml مربوط به MasterDNS/StormDNS هستند؛ بخش‌های مخصوص اندروید بر اساس رفتار WhiteZia توضیح داده شده‌اند."
    override val settingGuideSource = "بر اساس client_config.toml در MasterDNS/StormDNS و رفتار اجرایی WhiteZia."
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                SettingsGuideEntry(
                    ...
                    effect = "ورکر بیشتر روی گوشی سریع و ترافیک سنگین کمک می‌کند. ورکر زیاد باتری و CPU را هدر می‌دهد؛ WhiteZia تعداد ورکر پردازش را حداقل برابر RX/TX نگه می‌دارد.",
                ),
                SettingsGuideEntry(
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                ...
                SettingsGuideEntry(
                    ...
                    body = "WhiteZia می‌تواند کنار SOCKS5 یک پل HTTP proxy هم باز کند تا برنامه‌هایی که SOCKS5 ندارند کار کنند.",
        ...
        SettingsGuideSection(
            ...
            entries = listOf(
                ...
                SettingsGuideEntry(
                    ...
                    body = "WhiteZia می‌تواند بعد از اتصال چند درخواست کوچک تستی بفرستد و سپس هر چند وقت یک پروب سبک ارسال کند.",
    ...
    override val supportTitle = "حمایت از WHITEZIA"
    override val supportBody = "WhiteZia رایگان و متن‌باز است. اگر مفید بود، از توسعه آن حمایت کنید."
    ...
    override val bannerNotificationBlockedBody = "WhiteZia برای نمایش اعلان نیاز به مجوز دارد تا VPN فعال بماند. برای اعطای مجوز ضربه بزنید."
    override val bannerFullVpnWarningTitle = "هشدار عملکرد VPN کامل"
    override val bannerFullVpnWarningBody = "حالت VPN کامل تمام ترافیک دستگاه را از طریق WhiteZia هدایت می‌کند. این ممکن است در مقایسه با حالت پروکسی تأخیر و مصرف باتری را افزایش دهد."
    ...
    override val shareSubjectProfile = "پروفایل WhiteZia"
    override val shareChooserProfile = "اشتراک پروفایل WhiteZia"
    ...
    override val footerPoweredBy = "قدرت گرفته از WhiteZia"
    ...
    override val whiteZiaResolversLabel = "ریزالورهای WhiteZia"
    override val whiteZiaConfigsLabel = "تنظیمات WhiteZia"
    override val whiteZiaConfigsDescription = "محافظه‌کارانه: مصرف اینترنت کمتر، مناسب بیشتر کاربران"
    override val whiteZiaAggressiveConfigsLabel = "تنظیمات پرمصرف"
    override val whiteZiaAggressiveConfigsDescription = "پرمصرف: وقتی مصرف اینترنت برایتان مهم نیست استفاده کنید"
    override val whiteZiaLogsLabel = "لاگ‌های WhiteZia"
    override val whiteZiaDiagnosticsLabel = "تشخیص WhiteZia"
    ...
    override val qrScanNoCode = "هیچ پروفایل QR برای WhiteZia پیدا نشد"
