...
data class WhiteZiaScanLaunchRequest(
    val id: String,
...
object WhiteZiaScanRequestStore {
    ...
    fun load(context: Context, requestId: String): WhiteZiaScanLaunchRequest? {
    ...
    private fun encode(request: WhiteZiaScanLaunchRequest): JSONObject {
        return JSONObject()
            .put("id", request.id)
    ...
    private fun decode(json: JSONObject): WhiteZiaScanLaunchRequest {
        return WhiteZiaScanLaunchRequest(
