package shop.whitezia.client.storm
...
object StormDnsConfigRenderer {
    ...
    fun renderAdvancedSettingsToml(settings: WhiteZiaSettings): String {
        val resolved = settings.resolve()
        return buildString {
    ...
    private fun StringBuilder.appendAdvancedSettingsToml(resolved: ResolvedWhiteZiaSettings) {
