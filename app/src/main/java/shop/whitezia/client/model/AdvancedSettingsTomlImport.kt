...
fun WhiteZiaSettings.importAdvancedSettingsProfileFromToml(
    name: String,
    toml: String,
): WhiteZiaSettings {
...
private fun parseAdvancedSettingsProfileFromToml(
    ...
    var settings = WhiteZiaSettings()
    var importedSettingCount = 0

    fun applyIfPresent(key: String, update: (TomlValue) -> WhiteZiaSettings) {
...
private fun validateAdvancedSettingsRelations(settings: WhiteZiaSettings) {
