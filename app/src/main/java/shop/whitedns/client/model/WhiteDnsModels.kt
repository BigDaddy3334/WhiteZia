...
data class WhiteDnsSettings(
    ...
    val transportMode: String = WhiteDnsOptions.TransportAuto,
    val amneziaWgConfig: String = "",
    val operatorCode: String = WhiteDnsOptions.OperatorMegafonYota,
...
private fun normalizeTransportMode(raw: String): String {
    return when (raw) {
        WhiteDnsOptions.TransportDns -> WhiteDnsOptions.TransportDns
        else -> WhiteDnsOptions.TransportAuto
    }
}
